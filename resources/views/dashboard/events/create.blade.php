...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Create new order</h1></h1>
</div>
...
<div class="col-lg-8">
    <form method="post" action="/dashboard/events">
        ...
        <div class="mb-3">
            ...
            <input type="time" class="form-control @error('start_hour') is-invalid @enderror" id="start_hour" name="start_hour" required value="{{ old('start_hour') }}">
            @error('start_hour')
                <div class="invalid-feedback">
                    <strong>{{ $message }}</strong>
                </div>
        ...
        <div class="mb-3">
            ...
            <input type="time" class="form-control @error('end_hour') is-invalid @enderror" id="end_hour" name="end_hour" required value="{{ old('end_hour') }}">
            @error('end_hour')
                <div class="invalid-feedback">
                    <strong>{{ $message }}</strong>
                </div>
        ...
        {{-- <div class="mb-3">
            ...
            <input type="text" class="form-control @error('total_user') is-invalid @enderror" id="total_user" name="total_user" required autofocus value="{{ old('total_user') }}">
            @error('total_user')
                <div class="invalid-feedback">
                    <strong>{{ $message }}</strong>
                </div>
        ...
        <button type="submit" class="btn btn-primary mb-3" onclick="createEvent()">Add order</button>
    </form>
</div>
@endsection